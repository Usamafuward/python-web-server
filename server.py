...
PORT = 2728 # The port the server will listen on
ROOT = "C:\\Users\\User\\Downloads\\python-web-server-main\\htdocs\\" # Absolute path of the htdocs directory
PHP_FILE_PATH = "C:/Users/User/Downloads/python-web-server-main/htdocs" # Location of the PHP file
PHP_FILE_NAME = "form2.php" # Name of the PHP file to handle POST requests
PORT_2 = "8000" # Another port used for a PHP server
...
def handle_request(client_socket): # client_socket represents the socket connection with the client
    ...
    if (request_type == "POST"):
        ...
        try:
            with open(ROOT + "form1.php", "r") as file:
